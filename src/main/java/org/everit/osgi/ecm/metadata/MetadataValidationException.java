...
/**
 * A {@link RuntimeException} that is thrown if there is a problem with the metadata structure of
 * the component (e.g.: multiple attributes are provided with the same id).
 */
