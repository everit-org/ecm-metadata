...
/**
 * Metadata class for attributes that hold {@link String} or its array representation as a value.
 */
public class StringAttributeMetadata extends SelectablePropertyAttributeMetadata<String[]> {

  /**
   * Builder for {@link StringAttributeMetadata}.
   */
  ...
  protected StringAttributeMetadata(final StringAttributeMetadataBuilder builder) {
    super(builder);
  }
